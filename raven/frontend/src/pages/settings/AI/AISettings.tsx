            ...
            <FormProvider {...methods}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <SettingsContentContainer>
                        <SettingsPageHeader
                            title='AI Settings'
                            description='Configure AI providers to use AI features in Eden.'
    ...
    const handleTestConnection = async () => {
        ...
        try {
            const result = await testConnection({
                ...
                deployment_name: azureDeploymentName        // 👈 هنا الإضافة الجديدة
            })
            setTestResult({
                success: result.message.success,
                message: result.message.message
            ...
            if (result.message.success) toast.success('Connection successful!')
            else toast.error(result.message.message)
                ...
                <>
                    ...
                    <Box>
                        ...
                        <TextField.Root
                            ...
                            required
                            autoComplete='off'
                            placeholder='https://openaieden.openai.azure.com/'
                    ...
                    <Callout.Root size="1">
                        ...
                        <Callout.Text>
                            Make sure your Azure OpenAI deployment is live and the keys, endpoint, version, and deployment name are correct.
                        </Callout.Text>
                    </Callout.Root>
                </>
            ) : null}
