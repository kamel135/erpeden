    ...
    return (
        <PageContainer>
            <SettingsContentContainer>
                <SettingsPageHeader
                    title={__('Mobile App')}
                    description={__("Do more with Eden on your mobile.")}
                />
                ...
                <Text size='2'>Eden uses OAuth to authenticate users securely on the mobile app.
                    <br />
                    To use the Eden mobile app, you need to first create an <Link href="https://docs.frappe.io/framework/user/en/using_frappe_as_oauth_service" target='_blank'>OAuth Client <FiExternalLink /></Link>.
                    <br />
                    <br />
