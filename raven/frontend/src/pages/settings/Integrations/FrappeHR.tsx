            ...
            <FormProvider {...methods}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <SettingsContentContainer>
                        <SettingsPageHeader
                            title={__('HR')}
                            description={__("Connect your HR system to Eden to sync employee data and send notifications.")}
                        ...
                        <Flex direction={'column'} gap='2' maxWidth={'480px'}>
                            ...
                            <HelperText>
                                {__("If checked, users on Eden are notified if another user is on leave.")}
                            </HelperText>
                        </Flex>
                    </SettingsContentContainer>
                </form>
